  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        <span className="text-[10px] font-bold text-muted-foreground/60 uppercase tracking-widest whitespace-nowrap leading-none">
          HIZLI ERİŞİM
        </span>
      ...
      <div className="grid gap-3">
        {links.map((item) => (
          ...
          >
            ...
            <ChevronRight
              size={16}
              className="text-muted-foreground/40 transition-all group-hover:translate-x-1 group-hover:text-foreground"
            />
          </Link>
        ))}
      </div>
