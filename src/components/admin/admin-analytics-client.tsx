    ...
    <main className="space-y-8 p-6 lg:p-8 bg-slate-50/30 min-h-full">
      <section className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
        <div>
          ...
          <p className="mt-1.5 text-sm text-slate-500 font-medium italic">Platform performansını ve verilerini buradan takip edin.</p>
        </div>
            ...
            {["7d", "30d", "90d", "1y"].map((range) => (
              <button
                ...
                className={`px-4 py-2 text-[11px] font-bold uppercase tracking-wider rounded-lg transition-all ${
                  timeRange === range ? "bg-slate-800 text-white shadow-sm" : "text-slate-500 hover:text-slate-800"
                }`}
              >
