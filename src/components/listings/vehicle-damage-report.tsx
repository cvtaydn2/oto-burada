      ...
      <div className="grid md:grid-cols-[200px_1fr] gap-6">
        <div className="space-y-4">
          <div className="rounded-xl border border-border bg-muted/30 p-4 h-full">
            <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-widest mb-2">Tramer Tutari</h3>
        ...
        <div className="space-y-3">
          <h3 className="text-sm font-bold text-foreground mb-3 border-b border-border/50 pb-2">Kaporta Durumu</h3>
          {hasStatusFields ? (
              ...
              {activeParts.map((part) => {
                ...
                return (
                  <div key={part} className="flex flex-col gap-1.5">
                    <span className="text-[12px] font-bold text-muted-foreground tracking-tight">{carPartLabels[part]}</span>
