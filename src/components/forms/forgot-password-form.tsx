      ...
      <div className="flex items-center justify-center p-8 lg:p-24 relative overflow-hidden bg-slate-50/50">
        <div className="w-full max-w-md space-y-10 relative z-10">
          <div className="space-y-4">
            <Link
              href="/login"
              className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-primary transition-colors italic"
            >
              <ChevronLeft size={14} />
              GİRİŞE DÖN
            </Link>
          ...
          {(state as { success?: string }).success ? (
            ...
            <form action={formAction} className="space-y-6">
              <div className="space-y-2 group">
                <label className="text-[10px] font-black px-1 uppercase tracking-widest text-slate-400 italic group-focus-within:text-primary transition-colors">
                  E-POSTA ADRESİ
                </label>
