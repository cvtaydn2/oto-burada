    ...
    <div className="divide-y divide-slate-50">
          ...
          <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
            <div className="flex gap-4">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <Badge
                    className={`rounded-lg px-2 py-0.5 text-[8px] font-bold uppercase tracking-widest border-none ${
            ...
            <div className="flex items-center gap-4 shrink-0">
              <div className="flex flex-col items-end gap-1">
                <Badge
                  className={`rounded-xl h-8 px-4 flex items-center gap-2 border-none font-bold text-[9px] uppercase tracking-widest italic ${
                    ticket.status === "open"
      ...
      {initialTickets.length === 0 && (
        <div className="p-20 text-center flex flex-col items-center gap-4">
          ...
          <div>
            <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-slate-300 italic">
              Henüz bir destek talebi bulunmuyor
            </p>
            <p className="text-xs text-slate-400 font-medium mt-1">
              İşler gayet yolunda görünüyor.
            </p>
          </div>
        </div>
      )}
