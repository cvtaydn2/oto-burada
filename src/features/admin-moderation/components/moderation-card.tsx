              ...
              {editingListingId === listing.id ? (
                <>
                  <button
                    ...
                    className="h-10 px-5 rounded-xl bg-primary text-primary-foreground text-xs font-bold uppercase tracking-widest hover:bg-primary/90 disabled:opacity-50 transition-all shadow-lg shadow-primary/20"
                  >
                    {isSavingEdit ? (
                  ...
                  <button
                    ...
                    className="h-10 px-5 rounded-xl border border-border bg-card text-xs font-bold uppercase tracking-widest hover:bg-muted transition-all"
                  >
                ...
                <button
                  ...
                  className="h-10 px-5 rounded-xl border border-primary/20 bg-primary/5 text-primary text-xs font-bold uppercase tracking-widest hover:bg-primary hover:text-white transition-all shadow-sm"
                >
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex flex-wrap gap-2 justify-end">
                {[
                  {
                    label: "Kurallara uygun",
                    color: "bg-emerald-50 text-emerald-700 border-emerald-100",
                  },
                  {
                    label: "Düşük kalite görsel",
          ...
          <div className="flex flex-wrap items-center justify-between gap-6 pt-4 border-t border-border/40">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                disabled={actionBusy}
                className="h-12 px-8 rounded-2xl border border-border text-xs font-bold uppercase tracking-widest hover:bg-rose-50 hover:text-rose-600 hover:border-rose-100 transition-all disabled:opacity-50"
              >
                {rejecting ? (
              ...
              <button
                ...
                disabled={actionBusy}
                className="h-12 px-8 rounded-2xl bg-primary text-white text-xs font-bold uppercase tracking-widest hover:shadow-xl hover:shadow-primary/20 transition-all disabled:opacity-50"
              >
                {approving ? (
                  <LoaderCircle className="size-4 animate-spin" />
                ) : (
