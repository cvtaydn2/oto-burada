...
import type { SecurityCheckResult } from "@/features/shared/lib/security";
import {
  withAdminRoute,
  withCronOrAdmin,
  withUserAndCsrf,
  withUserRoute,
} from "@/features/shared/lib/security";
...
vi.mock("@/features/shared/lib", () => ({
  isValidRequestOrigin: vi.fn(),
}));

vi.mock("@/features/shared/lib/csrf", () => ({
