  ...
  return (
    <div className="mx-auto max-w-[1440px] px-6 lg:px-12 py-16 space-y-24 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <section className="flex flex-col lg:flex-row items-center gap-16">
        <div className="lg:w-1/2 space-y-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-primary italic">
              Vizyon & Misyon
            </span>
          </div>
          ...
          <p className="text-lg font-medium text-muted-foreground italic leading-relaxed">
            OtoBurada, sadece bir ilan sitesi değil; güvenin, hızın ve şeffaflığın dijital buluşma
            noktasıdır. Amacımız, araç alım-satım sürecini bir yorgunluktan çıkarıp premium bir
          ...
          <div className="flex gap-4">
            ...
            <div className="px-6 py-4 rounded-2xl bg-card border border-border/50 shadow-sm shadow-slate-200/20">
              <span className="block text-3xl font-bold italic tracking-tighter text-primary">
                Güvenli
              </span>
              <span className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground/70">
                Moderasyonlu Platform
              </span>
            </div>
          </div>
        </div>
        <div className="lg:w-1/2 relative">
          ...
          <div className="absolute -bottom-8 -left-8 bg-card p-8 rounded-2xl shadow-sm border border-border/50 z-20 hidden md:block">
            ...
            <h4 className="font-bold italic uppercase tracking-tighter text-foreground">
              %100 Güvenli
            </h4>
      ...
      <section className="bg-slate-950 rounded-[4rem] p-12 lg:p-20 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-3xl mx-auto space-y-10">
          <h2 className="text-4xl md:text-5xl font-bold italic uppercase tracking-tighter">
            Showroom Elite <span className="text-primary italic">Felsefesi</span>
          </h2>
          <p className="text-muted-foreground/70 font-medium italic leading-relaxed">
            Pazarın karmaşıklığını ve güvensizliğini ortadan kaldırmak için &quot;Elite&quot;
            standartlarını belirledik. Her ilan, her kullanıcı ve her etkileşim bizim için bir
            prestij meselesidir.
          </p>
      ...
      <section className="flex flex-col items-center text-center space-y-8 pb-10">
        <h2 className="text-4xl font-bold italic uppercase tracking-tightest">
          BU HİKAYENİN PARÇASI OLUN
        </h2>
