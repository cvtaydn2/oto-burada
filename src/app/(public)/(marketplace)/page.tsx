          ...
          <div className="flex flex-col md:flex-row justify-between items-baseline gap-2 sm:gap-4 mb-4 sm:mb-6 md:mb-8">
            <div>
              ...
              <p className="text-[10px] font-bold text-muted-foreground/60 uppercase tracking-widest">
                ARADIĞIN ARACA GİDEN EN KISA YOL
              </p>
            </div>
            <Link
              href="/listings"
              prefetch={false}
              className="group flex items-center gap-2 text-sm font-semibold text-primary hover:underline transition-all"
            >
              Tümünü İncele{" "}
        ...
        <section className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8 md:py-10 lg:py-16">
          <div className="flex justify-between items-end mb-8">
            ...
            <Link
              href="/listings"
              prefetch={false}
              className="text-sm font-medium text-primary hover:text-primary/80 flex items-center transition"
            >
              Tümünü Gör <ChevronRight size={14} className="ml-1" />
            </Link>
          </div>
          {latestListings.length > 0 ? (
            ...
            <div className="bg-card border border-border mt-6 rounded-2xl p-12 text-center shadow-sm">
              ...
              <p className="text-muted-foreground text-sm max-w-sm mx-auto">
                İlk ilanı sen vererek platformda yerini alabilirsin. Türkiye&apos;nin en güvenilir
                pazarına hemen katıl!
              </p>
              <Link
                href="/dashboard/listings/create"
                prefetch={false}
                className="mt-6 inline-flex items-center justify-center bg-primary text-primary-foreground px-6 py-2.5 rounded-xl font-bold hover:bg-primary/90 transition"
              >
                Hemen İlan Ver
              </Link>
            </div>
          ...
          <div className="mt-12 flex justify-center">
            <Link
              href="/listings"
              prefetch={false}
              className="bg-primary text-primary-foreground px-8 py-3 rounded-xl font-bold hover:bg-primary/90 transition shadow-sm shadow-primary/20"
            >
              Tüm İlanları Keşfet
            </Link>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={i}
                  className="group relative bg-card border border-border p-8 rounded-2xl transition-all duration-300"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <div className="prose-sm text-muted-foreground font-medium">
                  <p className="text-lg leading-relaxed mb-6 italic text-foreground">
                    ...
                    gerçekleştirin. Türkiye genelinde binlerce güncel ilanı keşfedin, hayalinizdeki
                    araca en uygun fiyatlarla ulaşın.
                  </p>
                  <p className="mb-6">
                    Platformumuzda yer alan her ilan, kullanıcılarımıza özel geliştirilmiş AI
                    destekli moderasyon ve şeffaf ekspertiz süreçlerinden geçer. İster aracınızı
                    hemen satmak isteyin, ister yeni bir araç arayışında olun, OtoBurada her adımda
                    yanınızda.
                  </p>
                </div>
              ...
              <div className="bg-card p-12 rounded-2xl border border-border shadow-sm">
                ...
                <ul className="space-y-6">
                  {[
                    ...
                    <li key={index} className="flex gap-4 items-start">
                      ...
                      <span className="text-foreground/80 font-bold text-sm tracking-tight">
                        {benefit}
                      </span>
                    </li>
                  ))}
                ...
                <div className="mt-10 pt-10 border-t border-border italic text-muted-foreground/50 text-xs font-medium uppercase tracking-[0.1em]">
                  * OtoBurada bir topluluk girişimidir ve kullanıcıların güvenli ticaret yapmalarını
                  hedefler.
                </div>
              </div>
            </div>
