  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 sm:px-6 py-12 space-y-16">
      ...
      <div className="text-center">
        <h1 className="text-4xl font-extrabold text-gray-800 mb-4">Bize Ulaşın</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="bg-blue-600 p-10 text-white flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10 mt-12 flex space-x-4">
            <a href="https://x.com/otoburada" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition" aria-label="X (Twitter)">
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            </a>
            <a href="https://instagram.com/otoburada" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition" aria-label="Instagram">
            ...
            <a href="https://linkedin.com/company/otoburada" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition" aria-label="LinkedIn">
      ...
      <div className="grid lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-4">
          <div className="bg-indigo-900 rounded-3xl p-10 text-white shadow-xl h-full flex flex-col justify-between relative overflow-hidden">
            ...
            <Link
              href="/support"
              className="relative z-10 mt-10 inline-flex items-center justify-between h-14 w-full px-6 rounded-2xl bg-white text-slate-900 text-xs font-bold uppercase tracking-widest hover:bg-blue-500 hover:text-white transition-all group"
            >
              Destek Merkezi
...
function ContactCard({ icon, title, description, value, color }: {
  ...
  return (
    <div className="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm hover:shadow-md transition-all group">
      ...
      <p className="text-lg font-bold text-gray-900 mb-3">{value}</p>
...
function FaqItem({ question, answer }: { question: string; answer: string }) {
  return (
    <div className="rounded-2xl border border-slate-100 bg-slate-50 p-6 hover:border-blue-200 transition-all">
