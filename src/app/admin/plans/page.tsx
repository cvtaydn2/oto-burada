      ...
      <section className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
        <div>
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-[10px] font-bold text-muted-foreground/70 uppercase tracking-[0.2em] italic">Gelir & Paketler</span>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="rounded-2xl border border-indigo-100 bg-card p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-[10px] font-bold text-muted-foreground/70 uppercase tracking-widest">Toplam Gelir</span>
          </div>
        ...
        <div className="rounded-2xl border border-emerald-100 bg-card p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-[10px] font-bold text-muted-foreground/70 uppercase tracking-widest">Toplam Satış</span>
          </div>
        ...
        <div className="rounded-2xl border border-blue-100 bg-card p-6 shadow-sm">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-[10px] font-bold text-muted-foreground/70 uppercase tracking-widest">Aktif Paket</span>
          </div>
      ...
      <div className="rounded-3xl border border-border bg-card shadow-sm overflow-hidden">
        ...
        {purchases.length === 0 ? (
          <div className="py-16 text-center">
            ...
            <p className="text-sm font-bold text-muted-foreground/70 uppercase tracking-widest">Henüz paket satışı yok</p>
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-muted/30/50 border-b border-border/50">
                  ...
                  <th className="px-6 py-3 text-[10px] font-bold text-muted-foreground/70 uppercase tracking-widest">Durum</th>
                  <th className="px-6 py-3 text-[10px] font-bold text-muted-foreground/70 uppercase tracking-widest">Tarih</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-50">
                {purchases.map((p) => (
