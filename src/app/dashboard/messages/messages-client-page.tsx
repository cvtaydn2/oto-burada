    ...
    <div className="flex h-full flex-col gap-4 p-3 sm:p-4 lg:flex-row">
      {showChatList && (
        <Card
          ...
          } flex min-h-[calc(100vh-14rem)] flex-1 flex-col overflow-hidden rounded-3xl border-border/60 p-4 shadow-sm md:p-5 lg:max-w-[380px]`}
        >
      ...
      {showChatWindow && (
        <Card
          className={`${
            !isMobile && !selectedChatId ? "hidden lg:flex" : ""
          } flex min-h-[calc(100vh-14rem)] flex-1 flex-col overflow-hidden rounded-3xl border-border/60 shadow-sm`}
        >
