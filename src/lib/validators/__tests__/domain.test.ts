  ...
  images: [
    {
      ...
      url: "https://example.supabase.co/storage/v1/object/public/listing-images/listings/user/uuid.jpg",
      order: 0,
      isCover: true,
    },
    {
      storagePath: "listings/user/uuid2.jpg",
      url: "https://example.supabase.co/storage/v1/object/public/listing-images/listings/user/uuid2.jpg",
      order: 1,
      isCover: false,
    },
    {
      storagePath: "listings/user/uuid3.jpg",
      url: "https://example.supabase.co/storage/v1/object/public/listing-images/listings/user/uuid3.jpg",
      order: 2,
      isCover: false,
    },
  ],
