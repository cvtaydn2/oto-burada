              ...
              - generic [ref=e84]:
                - generic [ref=e87]:
                  - generic [ref=e88]:
                    - img [ref=e90]
                    - generic [ref=e93]:
                      - heading "Ekspertiz Bilgileri" [level=3] [ref=e94]
                      - paragraph [ref=e95]: Aracın kaporta ve mekanik durumunu belirtin.
                  - generic [ref=e96]:
                    - generic [ref=e97]:
                      - heading "Kaporta Durumu (Boya / Değişen)" [level=4] [ref=e98]
                      - generic [ref=e99]:
                        - generic [ref=e101]:
                          - img [ref=e103]
                          - paragraph [ref=e105]: Aracın üzerindeki parçalara tıklayarak durumunu seçebilirsin.
                        - generic [ref=e106]:
                          - img [ref=e108]
                          - generic [ref=e125]:
                            - generic [ref=e126]:
                              - heading "EKSPERTİZ ÖZETİ (0 Parça)" [level=4] [ref=e127]
                              - generic [ref=e128]:
                                - img [ref=e129]
                                - paragraph [ref=e132]: Tüm parçalar orijinal
                                - paragraph [ref=e133]: Değişen veya boyalı parça varsa listeden veya görselden seçebilirsin.
                            - generic [ref=e134]:
                              - generic [ref=e135]:
                                - button "Kaput" [ref=e136]:
                                  - generic [ref=e137]: Kaput
                                  - img [ref=e138]
                                - button "Tavan" [ref=e140]:
                                  - generic [ref=e141]: Tavan
                                  - img [ref=e142]
                                - button "Bagaj" [ref=e144]:
                                  - generic [ref=e145]: Bagaj
                                  - img [ref=e146]
                                - button "Sol Ön Çamurluk" [ref=e148]:
                                  - generic [ref=e149]: Sol Ön Çamurluk
                                  - img [ref=e150]
                              - generic [ref=e152]:
                                - paragraph [ref=e153]: Hızlı İpucu
                                - paragraph [ref=e154]: Görsel üzerinde her parçayı kolayca işaretleyebilirsin. Şeffaf ekspertiz bilgisi alıcıların %40 daha hızlı karar vermesini sağlar.
                        - generic [ref=e155]:
                          - generic [ref=e156]: "Lejand:"
                          - generic [ref=e157]: Boyalı
                          - generic [ref=e159]: Lokal Boyalı
                          - generic [ref=e161]: Değişen
                    - generic [ref=e164]:
                      - text: Tramer Kaydı (TL)
                      - spinbutton [ref=e165]: "0"
                      - paragraph [ref=e166]: Hasar kaydı yoksa 0 giriniz.
                    - generic [ref=e167]:
                      - heading "Detaylı Ekspertiz Raporu (Opsiyonel)" [level=4] [ref=e168]
                      - generic [ref=e169]:
                        - generic [ref=e170]:
                          - generic [ref=e171]:
                            - img [ref=e173]
                            - generic [ref=e176]:
                              - heading "Profesyonel Ekspertiz Raporu" [level=4] [ref=e177]
                              - paragraph [ref=e178]: İlanınıza güven katar, 5 kat daha hızlı satış sağlar.
                          - generic [ref=e179]:
                            - button "YOK" [ref=e180]
                            - button "VAR" [ref=e181]
                        - generic [ref=e182]:
                          - img [ref=e183]
                          - heading "Raporun Yok mu?" [level=5] [ref=e186]
                          - paragraph [ref=e187]: Ekspertiz raporun yoksa bu aşamayı boş bırakabilirsin. Ancak raporlu ilanlar alıcıların daha çok ilgisini çeker.
                - generic [ref=e188]:
                  - button "Geri" [ref=e189]:
                    - img [ref=e190]
                    - text: Geri
                  - button "Sonraki Adım" [active] [ref=e192]:
                    - text: Sonraki Adım
                    - img [ref=e193]
          - generic [ref=e195]:
            - heading "1 ilan" [level=3] [ref=e196]
            - generic [ref=e198]:
              - generic [ref=e200]:
                - generic [ref=e202]: Yayında
                - paragraph [ref=e203]: 2018 Volkswagen Golf 1.6 TDI Comfortline
                - paragraph [ref=e204]: ₺875.000
                - generic [ref=e205]:
                  - generic [ref=e206]: "2018"
                  - generic [ref=e207]: •
                  - generic [ref=e208]: 118.000 km
              - generic [ref=e209]:
                - link "Düzenle" [ref=e210] [cursor=pointer]:
                  - /url: /dashboard/listings?edit=2f240bf5-7e85-4dd7-9df6-2b8bbf3d6dc1
                  - img [ref=e211]
                  - text: Düzenle
                - button "EİDS ile Doğrula" [ref=e214]:
                  - img [ref=e215]
                  - text: EİDS ile Doğrula
                - button "Hızlandır" [ref=e218]:
                  - img [ref=e219]
                  - text: Hızlandır
                - button "Yenile" [ref=e224]:
                  - img [ref=e225]
                  - text: Yenile
                - button "Arşivle" [ref=e228]:
                  - img [ref=e229]
                  - text: Arşivle
  - alert [ref=e232]
  - generic [ref=e234]:
    ...
    - generic [ref=e239]:
      - img [ref=e241]
      - generic [ref=e244]:
        - heading "OtoBurada'yı Uygulama Olarak Ekle" [level=3] [ref=e245]
        - paragraph [ref=e246]: İlanlara daha hızlı ulaşmak için ana ekranına ekle.
    - button "Uygulamayı Kur" [ref=e248]
```
