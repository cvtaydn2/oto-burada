...
- Name: e2e.spec.ts >> Navigation >> should show public favorites page for guests
...
Locator: locator('button[aria-label=\'Favorilere ekle\']:visible').first()
Expected: enabled
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('button[aria-label=\'Favorilere ekle\']:visible').first()
